...
namespace VRKeys {
    ...
    public class Keyboard : MonoBehaviour {
        ...
        private IEnumerator Start() {
            ...
            leftHand = player.transform.FindChildRecursive("LeftBaseController").gameObject;
            rightHand = player.transform.FindChildRecursive("RightBaseController").gameObject;
